return {
	...
	opts = {
		...
		cmake_kits_path = vim.fn.stdpath("config") .. "/lua/archvim/config/cmake-tool-kits.json", -- this is used to specify global cmake kits path, see CMakeKits for detailed usage
	...
	config = function(_, opts)
		...
		vim.api.nvim_create_autocmd("User", {
			...
			callback = function(args)
				...
				utils.project_set_cancel = function()
					cmake_component.setup(false)
				end
			end,
		})
